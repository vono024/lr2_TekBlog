...
@section('content')
    <div class="max-w-7xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-gray-400">Підписки, гаджети та девайси для розробників</p>
        </div>

        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            @forelse($products as $product)
                <div class="bg-slate-800 rounded-lg shadow-xl overflow-hidden border border-slate-700 hover:border-blue-500 transition transform hover:-translate-y-1">
