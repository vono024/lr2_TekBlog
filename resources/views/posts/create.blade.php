...
@section('content')
    <div class="max-w-3xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-100 mb-6">✍️ Створити новий пост</h1>

        <form action="{{ route('posts.store') }}" method="POST" class="bg-slate-800 rounded-lg shadow-xl p-8 border border-slate-700 space-y-6">
            @csrf
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('posts.index') }}" class="bg-slate-700 text-gray-300 px-6 py-3 rounded-lg hover:bg-slate-600 font-semibold transition">
                    ❌ Скасувати
                </a>
            </div>
        </form>
