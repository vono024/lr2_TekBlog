...
@section('content')
    <div class="max-w-3xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">✏️ Редагувати пост</h1>

        <form action="{{ route('posts.update', $post) }}" method="POST" class="bg-white rounded-lg shadow-lg p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex space-x-4">
                ...
                <a href="{{ route('posts.show', $post) }}" class="bg-gray-300 text-gray-700 px-6 py-3 rounded-lg hover:bg-gray-400 font-semibold">
                    ❌ Скасувати
                </a>
            </div>
        </form>
